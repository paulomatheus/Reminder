...
class HomeView: UIView {
    ...
    let welcomeLabel: UILabel = {
        let label = UILabel()
        label.text = "home.welcome.label.title".localized
    ...
    private func setupContraints(){
        NSLayoutConstraint.activate([
            ...
            newPrescriptionButton.topAnchor.constraint(equalTo: myPrescriptionButtons.bottomAnchor, constant: Metrics.medier),
